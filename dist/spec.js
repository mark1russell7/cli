        ...
        // ==========================================================================
        {
            ...
            options: [
                ...
                },
                {
                    ...
                    short: "f",
                    type: "boolean",
                    description: "Force full cleanup (rm node_modules/dist/lock) before install",
                    default: false,
                },
                {
                    name: "skip-git",
                    short: "g",
                    type: "boolean",
                    description: "Skip git commit/push after refresh",
                    default: false,
                },
                {
                    name: "yes",
            ...
            transform: (parsed) => ({
                ...
                skipGit: parsed.options["skip-git"] ?? false,
